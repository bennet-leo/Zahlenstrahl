...
//     Cookiename=Name;
//   //console.log("Cookiename gesetzt "+Cookiename );
// }
...
export async function processDataTableOrig(Cookiename){
 ...
 function drawSvg_Orig(svgRef: React.RefObject<SVGSVGElement>,name) {
    let Cookiename = name;
...
//Inhalte der Grafik werden erst generiert, wenn top und bot Zahlenwerte enthalten
    ...
    for (let index = 0; index < länge; index++) {    
        ...
        let stepskaliert = ((differenzStartEndelokal)/(differenzStartEnde))/2;
